...
export const CategoryNode = ({data, ...props}: CategoryNodeProps) => {
    ...
    return (
        <>
                ...
                <Flex justify="space-between" className="category"  style={{...categoryNodeBoxStyles,backgroundColor: selectedCategoryId === data.id ? colors.lightBlue : ""}}>
                    <Checkbox
                ...
                {(open) && data.subCategories?.map(category => (
